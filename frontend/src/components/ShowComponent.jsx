          ...
          <tbody>
            {posts.data.data.map((post) => (
              ...
              <tr key={post._id}>
                ...
                <td>
                  <img
                    src={"http://localhost:8000/api/postImages/" + post.image} ///on met sur le lien le nom du dossier image
                    alt={post.title}
                    width={50}
                    height={50}
                  />
                ...
                <td> <UpdateModalComponent id= {post._id} title ={post.title} date={post.date}/></td>
              </tr>
            ))}
          </tbody>
        </table>
